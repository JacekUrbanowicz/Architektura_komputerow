...
tekst_Unicode dw 'K','a', 017Ch ,'d','y',' ','z','n','a','k',' ' ; Zmiana wyœwietlania z na ¿
			  dw 'z','a','j','m','u','j','e',' ' 
			  dw '1','6',' ','b','i','t', 00F3h ,'w', 0 ; Zmiana wyœwietlania o na ó

tytul_Win1250 db 'Tekst w standardzie Windows 1250', 0 

tekst_Win1250 db 'Ka', 0BFh ,'dy znak zajmuje 8 bit', 0F3h ,'w', 0 ; Zmiana wyœwietlania z na ¿ i o na ó
