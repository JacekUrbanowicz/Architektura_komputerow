...
tekst db 10, 'Nazywam si'
      db 0A9h ; Zmiana wyœwietlania e na ê
      db ' Jacek Urbanowicz' , 10 
      db 'M'
      db 0A2h ; Zmiana wyœwietlania o na ó
      db 'j pierwszy 32-bitowy program ' 
      db 'asemblerowy dzia'
      db 88h ; Zmiana wyœwietlania l na ³
      db 'a ju'
      db 0BEh ; Zmiana wyœwietlania z na ¿
      db ' poprawnie!', 10 
 
.code 
_main PROC 
    mov  ecx, 94 ; liczba znaków wyœwietlanego tekstu 
